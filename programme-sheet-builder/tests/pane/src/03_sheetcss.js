  ...
  *{ box-sizing: border-box; }
  ...
  @media print{
    ...
    * { -webkit-print-color-adjust: exact; print-color-adjust: exact; }
    ...
    /* The pane does not behave like the agenda when it overruns. It is fixed,
       one page tall and overflow:hidden, so there is no page 3 to spill onto and
       no warning: the bottom of it is simply cut off, and what is at the bottom
       is Announcements - the only block on the sheet that is written the same
       week it is read. Rama has lost it in the post more than once.
       ...
       They are cut first, because leading costs nothing to read back. Type size
       is cut only where the words are reference matter - the Pathways glossary,
       the URLs, the parenthetical home club after an officer's name - and never
       on the officers' own names, which are the reason the pane exists.
       Measured by tests/pane/panefit.py against the page BOX, not the viewport:
       a full night (4 announcements) went from 23mm of headroom to 52mm, and the
       stress sheet (5 speeches, 6 announcements) from 6mm to 38mm. Six is one
       extra wrapped line away from losing text; thirty-eight is a real margin.
       ...
       of leading fixes that. That one wants a warning or a second column, not a
       smaller typeface. */
    aside h3{ font-size: 9.5px; line-height: 1.2; margin-bottom: 4px; padding-bottom: 2px; }
    .exco-block{ margin-bottom: 7px; break-inside: avoid; }
    .exco-item{ margin-bottom: 2.5px; }
    ...
    .exco-role{ font-size: 9.5px; line-height: 1.12; }
    .exco-name{ font-size: 10px; line-height: 1.16; }
    .exco-sub{ font-size: 8.5px; line-height: 1.12; }
    ...
    .links a{ font-size: 9px; line-height: 1.16; }
    .path-legend div{ font-size: 9px; line-height: 1.2; margin-bottom: 1px; }
    .announcements .announce-line{ font-size: 9px; line-height: 1.26; margin-bottom: 2px; }
    .holder-pair .hp-line{ line-height: 1.3; font-size: 10px; }
    .announcements .announce-gap{ height: 2px; }
